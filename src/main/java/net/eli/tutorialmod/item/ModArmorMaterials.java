...
public class ModArmorMaterials {
    public static final Holder<ArmorMaterial> CERVALITE_ARMOR_MATERIAL = register("cervalite", Util.make(new EnumMap<>(ArmorItem.Type.class),
            attribute -> {
            ...
            }), 20, 4f, 0.2f, () -> ModItems.CERVALITE.get());
